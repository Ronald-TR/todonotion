...
# docs
doc-get-theme:
	mkdir -p docs/src/themes/hugo-geekdoc
	curl -L https://github.com/thegeeklab/hugo-geekdoc/releases/latest/download/hugo-geekdoc.tar.gz | tar -xz -C docs/src/themes/hugo-geekdoc/ --strip-components=1
